cd /data/ig.tools/run_log/whois.agents/agent.size.3/agent.0.initial
...
cd /data/ig.tools/run_log/whois.agents/agent.size.3/agent.1.initial
python ../../../get_disk_usage.py > disk_usage
python ../../../parse_whois_agent_log.py /data14/ig.log/dev-analysis-nosql-01.vega.ironport.com.agent.1 > overview.txt
python ../../../generate_average.py

cd /data/ig.tools/run_log/whois.agents/agent.size.3/agent.2.initial
python ../../../get_disk_usage.py > disk_usage
